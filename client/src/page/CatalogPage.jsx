...
const CatalogPage = () => {
	...
	useEffect(() => {
		...
		setCurrentPage(1)
	}, [allProducts, priceRange, selectedSizes, selectedBrands, selectedCompositions, sortOption])
			...
			<div style={styles.productsGrid}>
				{currentProducts.map(product => (
					<div key={product.id} style={styles.productCard}>
						<a href={product.link} style={styles.productLink} target="_blank" rel="noopener noreferrer">
							<img
